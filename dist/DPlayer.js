(function(e, t) {
	...
	return function(e) {
		...
		e.exports = function(e) {
			...
			return e.video && !e.video.hasOwnProperty("type") && (e.video.type = "auto"), e.danmaku && !e.danmaku.hasOwnProperty("user") && (e.danmaku.user = "MHuajian"), e
		}
		...
		console.log("\n %c DPlayer 1.2.0 %c http://dplayer.js.org \n\n", "color: #fadfa3; background: #030307; padding:5px 0;", "background: #fadfa3; padding:5px 0;"), n(4);
		var i = n(0),
			d = n(3),
			o = n(2),
			r = n(1),
			...
			m = function() {
				function e(t) {
					var n = this;
					a(this, e), this.option = d(t);
					var l = new o(this.option.lang).tran;
					this.updateBar = function(e, t, n) {
						t = t > 0 ? t : 0, t = t < 1 ? t : 1, E[e + "Bar"].style[n] = 100 * t + "%"
					};
					var s = ["play", "pause", "canplay", "playing", "ended", "error"];
					this.event = {};
					for (var m = 0; m < s.length; m++) this.event[s[m]] = [];
					if (this.trigger = function(e) {
							for (var t = 0; t < n.event[e].length; t++) n.event[e][t]()
						}, this.element = this.option.element, this.option.danmaku || this.element.classList.add("dplayer-no-danmaku"), c && this.element.classList.add("dplayer-mobile"), this.element.innerHTML = r.main(t, p, l), this.arrow = this.element.offsetWidth <= 500, this.arrow) {
						var u = document.createElement("style");
						u.innerHTML = ".dplayer .dplayer-danmaku{font-size:18px}", document.head.appendChild(u)
					}
					...
					if (("auto" === this.option.video.type ? /m3u8(#|\?|$)/i.exec(this.option.video.url) : "hls" === this.option.video.type) && Hls.isSupported()) {
						var v = new Hls;
						v.attachMedia(this.video), v.on(Hls.Events.MEDIA_ATTACHED, function() {
							v.loadSource(n.option.video.url), v.on(Hls.Events.MANIFEST_PARSED, function(e, t) {
					...
					if (("auto" === this.option.video.type ? /.flv(#|\?|$)/i.exec(this.option.video.url) : "flv" === this.option.video.type) && flvjs.isSupported()) {
						...
						y.attachMediaElement(this.video), y.load()
					}
					...
					var h = this.element.getElementsByClassName("dplayer-video-wrap")[0],
						g = this.element.getElementsByClassName("dplayer-controller-mask")[0];
					if (c) {
						var f = function() {
						...
						h.addEventListener("click", f), g.addEventListener("click", f)
					...
					var k = function(e) {
						...
						b = function(e) {
							...
							if (document.fullscreenElement || document.mozFullScreenElement || document.webkitFullscreenElement)
								for (; null !== a && a !== n.element;) t += a.offsetLeft, a = a.offsetParent;
							else
								for (; null !== a;) t += a.offsetLeft, a = a.offsetParent;
							return l = document.body.scrollLeft + document.documentElement.scrollLeft, t - l
						},
						E = {};
					E.playedBar = this.element.getElementsByClassName("dplayer-played")[0], E.loadedBar = this.element.getElementsByClassName("dplayer-loaded")[0];
					...
					this.option.danmaku && this.video.addEventListener("seeking", function() {
						for (var e = 0; e < n.dan.length; e++) {
							if (n.dan[e].time >= n.video.currentTime) return void(n.danIndex = e);
					...
					this.setTime = function() {
						n.playedTime = setInterval(function() {
							B = n.video.currentTime, !C && B < x + .01 && !n.video.paused && (n.element.classList.add("dplayer-loading"), C = !0), C && B > x + .01 && !n.video.paused && (n.element.classList.remove("dplayer-loading"), C = !1), x = B, n.updateBar("played", n.video.currentTime / n.video.duration, "width"), n.element.getElementsByClassName("dplayer-ptime")[0].innerHTML = k(n.video.currentTime), n.trigger("playing")
						}, 100), n.option.danmaku && $ && (T = setInterval(function() {
							if (n.dan)
								for (var e = n.dan[n.danIndex]; e && n.video.currentTime > parseFloat(e.time);) n.pushDanmaku(e.text, e.color, e.type), e = n.dan[++n.danIndex]
						}, 100))
					}, this.clearTime = function() {
						clearInterval(n.playedTime), n.option.danmaku && clearInterval(T)
					}, L.addEventListener("click", function(e) {
						var t = e || window.event;
						w = L.clientWidth;
						var a = (t.clientX - b(L)) / w;
						a = a > 0 ? a : 0, a = a < 1 ? a : 1, n.updateBar("played", a, "width"), n.video.currentTime = parseFloat(E.playedBar.style.width) / 100 * n.video.duration
					});
					var M = function(e) {
							var t = e || window.event,
								a = (t.clientX - b(L)) / w;
							a = a > 0 ? a : 0, a = a < 1 ? a : 1, n.updateBar("played", a, "width"), n.element.getElementsByClassName("dplayer-ptime")[0].innerHTML = k(a * n.video.duration)
						},
						z = function e() {
							document.removeEventListener("mouseup", e), document.removeEventListener("mousemove", M), n.video.currentTime = parseFloat(E.playedBar.style.width) / 100 * n.video.duration, n.setTime()
						};
					L.addEventListener("mousedown", function() {
						w = L.clientWidth, n.clearTime(), document.addEventListener("mousemove", M), document.addEventListener("mouseup", z)
					}), E.volumeBar = this.element.getElementsByClassName("dplayer-volume-bar-inner")[0];
					var N = this.element.getElementsByClassName("dplayer-volume")[0],
						q = this.element.getElementsByClassName("dplayer-volume-bar-wrap")[0],
						D = this.element.getElementsByClassName("dplayer-volume-bar")[0],
					...
					var S = function(e) {
							var t = e || window.event,
								a = (t.clientX - b(D) - 5.5) / 35;
							n.volume(a)
						},
						P = function e() {
							document.removeEventListener("mouseup", e), document.removeEventListener("mousemove", S), N.classList.remove("dplayer-volume-active")
						};
					q.addEventListener("click", function(e) {
						...
						document.addEventListener("mousemove", S), document.addEventListener("mouseup", P), N.classList.add("dplayer-volume-active")
					}), I.addEventListener("click", function() {
						n.video.muted ? (n.video.muted = !1, n.switchVolumeIcon(), n.updateBar("volume", n.video.volume, "width")) : (n.video.muted = !0, I.innerHTML = i("volume-off"), n.updateBar("volume", 0, "width"))
					});
					var H = 0;
					if (!c) {
						var F = function() {
							n.element.classList.remove("dplayer-hide-controller"), clearTimeout(H), H = setTimeout(function() {
								n.video.played.length && (n.element.classList.add("dplayer-hide-controller"), X(), se())
							}, 2e3)
						};
					...
					var O = r.setting(l),
						R = this.element.getElementsByClassName("dplayer-setting-icon")[0],
						A = this.element.getElementsByClassName("dplayer-setting-box")[0],
						j = this.element.getElementsByClassName("dplayer-mask")[0];
					A.innerHTML = O.original;
					var X = function() {
							A.classList.contains("dplayer-setting-box-open") && (A.classList.remove("dplayer-setting-box-open"), j.classList.remove("dplayer-mask-show"), setTimeout(function() {
								A.classList.remove("dplayer-setting-box-narrow"), A.innerHTML = O.original, V()
							}, 300))
						},
						W = function() {
							A.classList.add("dplayer-setting-box-open"), j.classList.add("dplayer-mask-show")
						};
					...
					var _ = this.option.loop,
						Y = this.element.getElementsByClassName("dplayer-danmaku")[0],
						$ = !0,
						V = function() {
							var e = n.element.getElementsByClassName("dplayer-setting-loop")[0],
								t = e.getElementsByClassName("dplayer-toggle-setting-input")[0];
							t.checked = _, e.addEventListener("click", function() {
								t.checked = !t.checked, t.checked ? (_ = !0, n.video.loop = _) : (_ = !1, n.video.loop = _), X()
							});
							var a = n.element.getElementsByClassName("dplayer-setting-showdan")[0],
								l = a.getElementsByClassName("dplayer-showdan-setting-input")[0];
							if (l.checked = $, a.addEventListener("click", function() {
									if (l.checked = !l.checked, l.checked) {
										if ($ = !0, n.option.danmaku) {
											for (var e = 0; e < n.dan.length; e++) {
									...
									} else $ = !1, n.option.danmaku && (clearInterval(T), Y.innerHTML = '<div class="dplayer-danmaku-item  dplayer-danmaku-item--demo"></div>', n.danTunnel = {
										right: {},
										top: {},
										bottom: {}
									...
									A.classList.add("dplayer-setting-box-narrow"), A.innerHTML = O.speed;
									for (var e = A.getElementsByClassName("dplayer-setting-speed-item"), t = 0; t < e.length; t++)(function(t) {
										e[t].addEventListener("click", function() {
											n.video.playbackRate = e[t].dataset.speed, X()
										})
									})(t)
								}), n.option.danmaku) {
								...
								var o = function(e) {
										...
										for (var l = n.element.getElementsByClassName("dplayer-danmaku-item"), s = 0; s < l.length; s++) l[s].style.opacity = a;
										n.danOpacity = a, localStorage.setItem("DPlayer-opacity", n.danOpacity)
									},
									r = function e() {
										document.removeEventListener("mouseup", e), document.removeEventListener("mousemove", o), d.classList.remove("dplayer-setting-danmaku-active")
									};
								s.addEventListener("click", function(e) {
									...
									document.addEventListener("mousemove", o), document.addEventListener("mouseup", r), d.classList.add("dplayer-setting-danmaku-active")
								})
							}
						};
					V(), this.video.addEventListener("durationchange", function() {
						...
						n.element.getElementsByClassName("dplayer-ptime")[0].innerHTML = "Error happens ╥﹏╥", n.trigger("pause")
					}), this.video.addEventListener("canplay", function() {
						n.trigger("canplay")
					}), this.ended = !1, this.video.addEventListener("ended", function() {
						n.updateBar("played", 1, "width"), _ || (n.ended = !0, n.pause(), n.trigger("ended"))
					}), this.video.addEventListener("play", function() {
						n.paused && n.play()
					}), this.video.addEventListener("pause", function() {
						n.paused || n.pause()
					}), this.video.volume = parseInt(this.element.getElementsByClassName("dplayer-volume-bar-inner")[0].style.width) / 100, this.video.loop = _, 1 !== this.video.duration && (this.element.getElementsByClassName("dplayer-dtime")[0].innerHTML = this.video.duration ? k(this.video.duration) : "00:00"), this.danTunnel = {
						right: {},
						top: {},
						bottom: {}
					}, this.itemDemo = this.element.getElementsByClassName("dplayer-danmaku-item")[0], this.option.danmaku ? (this.danIndex = 0, this.readDanmaku()) : this.option.autoplay && !c ? this.play() : c && this.pause();
					var U = this.element.getElementsByClassName("dplayer-comment-input")[0],
						J = this.element.getElementsByClassName("dplayer-comment-icon")[0],
						G = this.element.getElementsByClassName("dplayer-comment-box")[0],
						K = this.element.getElementsByClassName("dplayer-comment-setting-icon")[0],
						Q = this.element.getElementsByClassName("dplayer-comment-setting-box")[0],
						Z = this.element.getElementsByClassName("dplayer-send-icon")[0],
						ee = function(e) {
							return e.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2f;")
						},
						te = function() {
							if (U.blur(), !U.value.replace(/^\s+|\s+$/g, "")) return void alert("Please input danmaku!");
							var e = {
							...
							n.option.apiBackend.send(n.option.danmaku.api, e), U.value = "", se(), n.dan.splice(n.danIndex, 0, e), n.danIndex++, n.pushDanmaku(ee(e.text), e.color, e.type).style.border = "2px solid " + n.option.theme
						},
						ne = function() {
							Q.classList.contains("dplayer-comment-setting-open") && Q.classList.remove("dplayer-comment-setting-open")
						},
						ae = function() {
							Q.classList.contains("dplayer-comment-setting-open") ? Q.classList.remove("dplayer-comment-setting-open") : Q.classList.add("dplayer-comment-setting-open")
						},
						le = 0,
						se = function() {
							G.classList.contains("dplayer-comment-box-open") && (G.classList.remove("dplayer-comment-box-open"), j.classList.remove("dplayer-mask-show"), clearInterval(le), n.element.classList.remove("dplayer-show-controller"), ne())
						},
						ie = function() {
							G.classList.add("dplayer-comment-box-open"), j.classList.add("dplayer-mask-show"), le = setInterval(function() {
								clearTimeout(H)
							}, 1e3), n.element.classList.add("dplayer-show-controller")
						};
					j.addEventListener("click", function() {
						se()
					}), J.addEventListener("click", function() {
						...
						n.element.querySelector('input[name="dplayer-danmaku-color-${index}"]:checked+span') && (K.getElementsByClassName("dplayer-fill")[0].style.fill = n.element.querySelector('input[name="dplayer-danmaku-color-${index}"]:checked').value)
					...
					var de = function() {
						for (var e = Y.offsetWidth, t = n.element.getElementsByClassName("dplayer-danmaku-item"), a = 0; a < t.length; a++) t[a].style.transform = "translateX(-" + e + "px)"
					};
					this.element.addEventListener("fullscreenchange", function() {
						...
						document.fullscreenElement || document.mozFullScreenElement || document.webkitFullscreenElement ? document.cancelFullScreen ? document.cancelFullScreen() : document.mozCancelFullScreen ? document.mozCancelFullScreen() : document.webkitCancelFullScreen && document.webkitCancelFullScreen() : n.element.requestFullscreen ? n.element.requestFullscreen() : n.element.mozRequestFullScreen ? n.element.mozRequestFullScreen() : n.element.webkitRequestFullscreen ? n.element.webkitRequestFullscreen() : n.video.webkitEnterFullscreen && n.video.webkitEnterFullscreen(), de()
					...
					var oe = function(e) {
						...
						if ("INPUT" !== t && "TEXTAREA" !== t && "" !== a && "true" !== a) {
							...
							switch (l.keyCode) {
								case 32:
									l.preventDefault(), n.toggle();
									break;
								case 37:
									l.preventDefault(), n.video.currentTime = n.video.currentTime - 5;
									break;
								case 39:
									l.preventDefault(), n.video.currentTime = n.video.currentTime + 5;
									break;
								case 38:
									l.preventDefault(), s = n.video.volume + .1, n.volume(s);
									break;
								case 40:
									l.preventDefault(), s = n.video.volume - .1, n.volume(s)
							}
					...
					this.option.hotkey && document.addEventListener("keydown", oe), document.addEventListener("keydown", function(e) {
						switch ((e || window.event).keyCode) {
							case 27:
								n.element.classList.contains("dplayer-fulled") && (n.element.classList.remove("dplayer-fulled"), de())
						}
					});
					var re = this.element.getElementsByClassName("dplayer-menu")[0];
					if (this.element.addEventListener("contextmenu", function(e) {
							var t = e || window.event;
							t.preventDefault(), re.classList.add("dplayer-menu-show");
							var a = n.element.getBoundingClientRect(),
								l = t.clientX - a.left,
								s = t.clientY - a.top;
							l + re.offsetWidth >= a.width ? (re.style.right = a.width - l + "px", re.style.left = "initial") : (re.style.left = t.clientX - n.element.getBoundingClientRect().left + "px", re.style.right = "initial"), s + re.offsetHeight >= a.height ? (re.style.bottom = a.height - s + "px", re.style.top = "initial") : (re.style.top = t.clientY - n.element.getBoundingClientRect().top + "px", re.style.bottom = "initial"), j.classList.add("dplayer-mask-show"), j.addEventListener("click", function() {
								j.classList.remove("dplayer-mask-show"), re.classList.remove("dplayer-menu-show")
							})
						}), this.option.screenshot) {
						var ce = this.element.getElementsByClassName("dplayer-camera-icon")[0];
						ce.addEventListener("click", function() {
							var e = document.createElement("canvas");
							e.width = n.video.videoWidth, e.height = n.video.videoHeight, e.getContext("2d").drawImage(n.video, 0, 0, e.width, e.height), ce.href = e.toDataURL(), ce.download = "DPlayer.png"
						})
					}
					p++
				}
				return s(e, [{
					key: "play",
					value: function(e) {
						"[object Number]" === Object.prototype.toString.call(e) && (this.video.currentTime = e), this.paused = !1, this.video.paused && (this.bezel.innerHTML = i("play"), this.bezel.classList.add("dplayer-bezel-transition")), this.playButton.innerHTML = i("pause"), this.video.play(), this.playedTime && this.clearTime(), this.setTime(), this.element.classList.add("dplayer-playing"), this.trigger("play")
					}
				}, {
					key: "pause",
					value: function() {
						this.paused = !0, this.element.classList.remove("dplayer-loading"), this.video.paused || (this.bezel.innerHTML = i("pause"), this.bezel.classList.add("dplayer-bezel-transition")), this.ended = !1, this.playButton.innerHTML = i("play"), this.video.pause(), this.clearTime(), this.element.classList.remove("dplayer-playing"), this.trigger("pause")
					}
				}, {
					key: "volume",
					value: function(e) {
					...
					value: function(e, t) {
						for (var n = [], a = 0, l = 0; l < e.length; ++l) this.option.apiBackend.read(e[l], function(l) {
							return function(s, i) {
								if (++a, s ? (s.response ? alert(s.response.msg) : console.log("Request was unsuccessful: " + s.status), n[l] = []) : n[l] = i, a == e.length) return t(n)
							}
						}(l))
					}
				}, {
					...
					value: function() {
						...
						a.push(n), this._readAllEndpoints(a, function(n) {
							e.danIndex = 0, e.dan = [].concat.apply([], n).sort(function(e, t) {
					...
					value: function(e, t, n) {
						var a = this,
							s = this.element.getElementsByClassName("dplayer-danmaku")[0],
							i = this.arrow ? 24 : 30,
							d = void 0,
							o = void 0,
							r = void 0,
							c = function(e) {
								return s.getBoundingClientRect().right - e.getBoundingClientRect().right
							},
							p = function(e) {
								return (d + e) / 5
							},
							m = function(e, t, n) {
								for (var s = d / p(n), i = 0;; i++) {
									var o = function(n) {
										var l = a.danTunnel[t][n + ""];
										if (!l || !l.length) return a.danTunnel[t][n + ""] = [e], e.addEventListener("animationend", function() {
										...
										for (var i = 0; i < l.length; i++) {
											var o = c(l[i]) - 10;
											if (o <= d - s * p(l[i].offsetWidth) || o <= 0) break;
											if (i === l.length - 1) return a.danTunnel[t][n + ""].push(e), e.addEventListener("animationend", function() {
												a.danTunnel[t][n + ""].splice(0, 1)
											}), {
												v: n % r
											}
						...
						n || (n = "right"), t || (t = "#fff"), d = s.offsetWidth, o = s.offsetHeight, r = parseInt(o / i);
						var u = document.createElement("div");
						u.classList.add("dplayer-danmaku-item"), u.classList.add("dplayer-danmaku-" + n), u.innerHTML = e, u.style.opacity = this.danOpacity, u.style.color = t, u.addEventListener("animationend", function() {
							s.removeChild(u)
						}), this.itemDemo.innerHTML = e;
						var v = this.itemDemo.offsetWidth;
						switch (n) {
							case "right":
								u.style.top = i * m(u, n, v) + "px", u.style.width = v + 1 + "px", u.style.transform = "translateX(-" + d + "px)";
								break;
							case "top":
						...
						return s.appendChild(u), u.classList.add("dplayer-danmaku-move"), u
					}
				}, {
					key: "switchVideo",
					value: function(e, t) {
		...
		var a = function(e, t, n, a, l) {
			...
			}, s.open(null !== t ? "POST" : "GET", e, true), s.send(null !== t ? JSON.stringify(t) : null)
		};
		e.exports = {
			send: function(e, t) {
				a(e, t, function(e, t) {
